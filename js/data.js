...
const MESES = [
  ...
  // ============================================
  {
    ...
    contenido: [
      ...
      { tipo: "foto", src: BASE_URL + "93.jpg", caption: "✨ Viendo las luces de navidad 🎄" },
      { tipo: "foto", src: BASE_URL + "94.jpg", caption: "✨ Disfrutando de tu dia juntos" },
      { tipo: "foto", src: BASE_URL + "95.jpg", caption: "✨ Navidad en el puerto" },
      { tipo: "foto", src: BASE_URL + "91.jpg", caption: "🎂 Feliz cumpleaños, amor! 🥳" },
      { tipo: "foto", src: BASE_URL + "92.jpg", caption: "🎂 Que se note el dominio de la IA" },
      { tipo: "foto", src: BASE_URL + "90.jpg", caption: "👶 Pero que pocholita eras amooor, me muero 😄" },
      { tipo: "foto", src: BASE_URL + "96.jpg", caption: "👶 Osea comprame un cliquete sabes soy de santcu tia" },
      { tipo: "foto", src: BASE_URL + "97.jpg", caption: "👶 Mirada intensa de pelicula soy bailarina no lo entenderias xD 💛" },
      { tipo: "foto", src: BASE_URL + "98.jpg", caption: "👶 Una foto asi como que no miro va?" },
      { tipo: "foto", src: BASE_URL + "99.jpg", caption: "👶 Porque no fuimos al insti juntos que sino jiji💛" },
      { tipo: "foto", src: BASE_URL + "100.jpg", caption: "🛁 Regalo sorpresa" },
      { tipo: "foto", src: BASE_URL + "101.jpg", caption: "🛁 Barcelona relax" },
      { tipo: "foto", src: BASE_URL + "102.jpg", caption: " Lo necesitábamos más que el aire" },
      { tipo: "foto", src: BASE_URL + "103.jpg", caption: "🍷 No se como describir esta foto xD 💛" },
      { tipo: "foto", src: BASE_URL + "104.jpg", caption: "🍷 Hotel Barcelona" },
      { tipo: "foto", src: BASE_URL + "105.jpg", caption: "Lo guapa que ibas amor aunque siempre lo estas" },
      { tipo: "foto", src: BASE_URL + "106.jpg", caption: "💛 Al SPA dios que guay la sauna" },
      { tipo: "foto", src: BASE_URL + "107.jpg", caption: "💛 PRETTY WOMAN" },
      { tipo: "foto", src: BASE_URL + "108.jpg", caption: "💛 Gracias por ese respiro amor" },
      { tipo: "foto", src: BASE_URL + "109.jpg", caption: "💛 Antes de la cena" },
      { tipo: "foto", src: BASE_URL + "110.jpg", caption: "💛 fardando de guapura" },
      { tipo: "foto", src: BASE_URL + "111.jpg", caption: "💛 a la cenita" },
      { tipo: "foto", src: BASE_URL + "112.jpg", caption: "💛 MI mujer" },
      { tipo: "foto", src: BASE_URL + "113.jpg", caption: "💛 Un vinito please" },
      { tipo: "foto", src: BASE_URL + "114.jpg", caption: "💛 como nos gusta" },
      { tipo: "foto", src: BASE_URL + "115.jpg", caption: "🥂 yo haciendote fotos a escondidas✨" },
      { tipo: "foto", src: BASE_URL + "116.jpg", caption: "🥂 Despedimos el año amor" },
      { tipo: "foto", src: BASE_URL + "117.jpg", caption: "🥂 No se puede ser mas guapa de verdad bfff... 😍" },
      { tipo: "foto", src: BASE_URL + "118.jpg", caption: "🥂 Pero de verdad que he hecho para tener a esta mujer(NO ES UNA QUEJA)" },
      { tipo: "foto", src: BASE_URL + "119.jpg", caption: "🥂 Feliz Año Nuevo, mi amor💛" },
      { tipo: "foto", src: BASE_URL + "120.jpg", caption: "🥂 Nochevieja" },
      { tipo: "foto", src: BASE_URL + "121.jpg", caption: "🥂 Celebrando el año con la familia💛" }
    ]
  },
